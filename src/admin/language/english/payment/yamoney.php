...
$_['kassa_test_mode_info'] = 'Вы включили тестовый режим приема платежей. Проверьте, как проходит оплата. <a href="">Подробнее</a>';
...
$_['kassa_account_help'] = "Shop ID, scid, ShopPassword можно посмотреть в <a href='https://kassa.yandex.ru/my' target='_blank'>личном кабинете</a> после подключения Яндекс.Кассы.";
...
$_['kassa_tax_rate_table_label'] = ' передавать в Яндекс.Кассу как ';
